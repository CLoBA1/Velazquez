...
@section('content')
        ...
        <form action="{{ route('admin.construction.store') }}" method="POST" enctype="multipart/form-data" 
            ...
            <div x-show="material_type === 'weight'" x-transition class="space-y-6">
                <div class="bg-orange-50/50 p-6 rounded-2xl border border-orange-100 shadow-sm grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" step="0.01" name="weight_per_bulto" x-model.number="weight_per_bulto" required
                                class="w-full rounded-xl border-slate-200 focus:ring-orange-500 focus:border-orange-500">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" step="0.50" name="price_bulto" x-model.number="price_bulto" required
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute left-3 top-2.5 text-slate-400">$</span>
                            <input type="number" step="0.50" name="price_tonelada" x-model.number="price_tonelada" required
                                class="pl-7 w-full rounded-xl border-slate-200 focus:ring-orange-500 focus:border-orange-500 font-bold text-lg">
                        </div>
                    </div>
                ...
                <!-- STOCK POR PESO -->
                <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                    <h3 class="font-bold text-slate-800 mb-4">Ingreso de Existencia Inicial</h3>
            ...
            <div x-show="material_type === 'piece'" x-transition class="space-y-6">
                <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label class="block text-sm font-bold text-slate-700 mb-2">Stock Inicial (Piezas)</label>
    ...
    <script>
        function constructionForm() {
            return {
                material_type: 'weight', // 'weight' or 'piece'
                ...
                // Sync tonelada auto-price when bulto changes (helper)
                init() {
