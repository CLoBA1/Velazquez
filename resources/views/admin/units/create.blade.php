...
@section('content')
    <div class="flex items-center justify-between mb-8">
        <div>
            <h1 class="text-3xl font-bold text-slate-900 tracking-tight">Nueva unidad</h1>
            <p class="text-slate-500 mt-1">Registra una nueva unidad de medida.</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.units.store') }}" class="space-y-6">
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input name="name" value="{{ old('name') }}" required placeholder="Ej: Pieza, Kilogramo, Metro"
                ...
                <div>
                    ...
                    <input name="symbol" value="{{ old('symbol') }}" required placeholder="Ej: pz, kg, m"
