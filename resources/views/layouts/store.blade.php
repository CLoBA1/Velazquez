...
<body
    ...
    <div x-data="{ show: false }" @scroll.window="show = window.scrollY > 400"
        ...
        <button @click="window.scrollTo({ top: 0, behavior: 'smooth' })"
            class="w-12 h-12 rounded-full bg-dark text-white shadow-xl flex items-center justify-center hover:bg-primary hover:scale-110 transition-all duration-300"
